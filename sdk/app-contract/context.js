...
export const HANA_PLUGIN_USER_INTERACTION_V2_MEMBERS = ["ask", "dismiss", "show"];
...
export const HANA_PLUGIN_CONTEXT_V2_MEMBERS = ["appEvents", "bus", "commands", "config", "dataDir", "documents", "environments", "hooks", "inputBanner", "inputStatus", "instances", "launchArgs", "logger", "mcp", "media", "messageRenderers", "models", "network", "providers", "publicData", "resources", "routes", "runtime", "shortcuts", "storage", "surfaces", "tasks", "tools", "userInteraction", "windows"];
